...
export const TRIGGER_TYPES = [
  ...
  { type: 'trigger_instagram_dm', label: 'Instagram DM', category: 'trigger', channel: 'instagram', description: 'Starts when an Instagram DM arrives' },
  { type: 'trigger_instagram_comment', label: 'Instagram Comment', category: 'trigger', channel: 'instagram', description: 'Starts when someone comments on a post/reel' },
  { type: 'trigger_facebook_dm', label: 'Facebook Messenger', category: 'trigger', channel: 'facebook', description: 'Starts when a Facebook Messenger message arrives' },
  { type: 'trigger_facebook_comment', label: 'Facebook Comment', category: 'trigger', channel: 'facebook', description: 'Starts when someone comments on a Page post' },
];
