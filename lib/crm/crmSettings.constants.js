...
export const CRM_MESSAGE_GROUPS = [
  ...
  {
    id: 'won',
    title: 'Thank-you on win',
    description: 'Sent when a lead is marked Won or converted to a customer.',
    trigger: 'Lead won / converted',
    icon: 'won',
    channels: [
      {
        toggleKey: 'sendWonThanksWhatsApp',
        label: 'WhatsApp',
        channel: 'whatsapp',
        templateKey: 'wonWhatsApp',
        defaultTemplate: DEFAULT_CRM_TEMPLATES.won_whatsapp,
        requires: 'phone',
      },
      {
        toggleKey: 'sendWonThanksEmail',
        label: 'Email',
        channel: 'email',
        templateKey: 'wonEmail',
        defaultTemplate: DEFAULT_CRM_TEMPLATES.won_email,
