  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FAFDFA] flex items-center justify-center">
        <Loader2 className="w-12 h-12 text-[#1D4B3E] animate-spin" />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#FAFDFA]">
        ...
        <div className="max-w-lg mx-auto px-6 pt-32 text-center">
          ...
          <a href="/login" className="inline-block mt-6 px-6 py-3 rounded bg-[#1D4B3E] text-white font-semibold text-sm">
            Sign in
          </a>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#FAFDFA] pb-20 font-sans">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center md:items-end gap-8">
            <div className="relative">
              <div className="w-24 h-24 md:w-28 md:h-28 rounded bg-[#BAE0CF] flex items-center justify-center border border-[#BAE0CF] shadow-sm">
                <span className="text-3xl font-bold text-[#163c32] select-none">
            ...
            <div className="flex-1 text-center md:text-left space-y-2">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                ...
                <span className="px-3 py-1 rounded-full bg-[#F0F9F5] text-[#163c32] text-[10px] font-bold uppercase tracking-widest border border-[#BAE0CF]">
                  {planLabel}
                </span>
              </div>
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded font-semibold transition-all flex items-center gap-2 text-sm ${
                isEditing ? "bg-[#F0F9F5] text-[#163c32]" : "bg-white text-[#111827] border border-[#BAE0CF] hover:bg-[#F0F9F5]"
              }`}
            >
      ...
      <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          {/* Identity */}
          <section className="rounded border border-[#BAE0CF] bg-white p-6 lg:p-8 shadow-sm">
            <div className="flex items-center justify-between border-b border-[#F0F9F5] pb-4 mb-6">
              <h2 className="text-lg font-bold text-[#111827]">Profile</h2>
              <span className="flex items-center gap-1.5 text-xs font-semibold text-[#1D4B3E] bg-[#F0F9F5] px-2 py-1 rounded-md">
            ...
            {isEditing ? (
              <form onSubmit={handleUpdate} className="space-y-6">
                  ...
                  {[
                    ...
                    <div key={key}>
                      ...
                      <input
                        ...
                        className="w-full bg-[#F0F9F5]/60 border border-[#BAE0CF] rounded px-4 py-3 text-sm focus:ring-2 focus:ring-[#F0F9F5]0/30 outline-none"
                      />
                    </div>
                  ))}
                </div>
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full bg-[#1D4B3E] text-white rounded py-3.5 font-semibold hover:bg-[#163c32] transition flex items-center justify-center gap-2"
                >
          ...
          {userData.business && (
            <section className="rounded border border-[#BAE0CF] bg-white p-6 lg:p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                <Zap className="w-5 h-5 text-[#1D4B3E]" />
                <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  <div key={item.label} className="p-4 rounded bg-[#FAFDFA] border border-[#BAE0CF]/80">
                    ...
                    {features.map((f) => (
                      <div
                        ...
                        className={`flex items-center justify-between px-3 py-2.5 rounded-lg border text-sm ${
                          f.enabled
                            ? "border-[#BAE0CF] bg-[#F0F9F5] text-[#111827]"
                            : "border-slate-100 bg-slate-50 text-[#94A3B8]"
                        }`}
                      >
                        <span className="font-medium">{f.label}</span>
                        {f.enabled ? (
                          <ToggleRight className="w-5 h-5 text-[#1D4B3E] shrink-0" />
                        ) : (
          ...
          {/* Security */}
          <section className="rounded border border-[#BAE0CF] bg-white p-6 shadow-sm">
            <h3 className="text-sm font-bold uppercase tracking-widest text-[#94A3B8] mb-4">Security</h3>
            <div className="grid md:grid-cols-2 gap-3">
              <div className="p-4 rounded border border-[#BAE0CF] flex items-center justify-between">
              ...
              <div className="p-4 rounded border border-[#BAE0CF] flex items-center justify-between">
                ...
                <span className={`text-xs font-semibold ${userData.business?.featureFlags?.apiAccess ? "text-[#1D4B3E]" : "text-[#94A3B8]"}`}>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="rounded border border-[#BAE0CF] bg-white p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-5">
              <BarChart3 className="w-4 h-4 text-[#1D4B3E]" />
            ...
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-[#F0F9F5]">
                ...
                <div className="w-full h-2 bg-[#BAE0CF] rounded-full overflow-hidden">
                  <div className="h-full bg-[#1D4B3E] rounded-full transition-all" style={{ width: `${leadProgress}%` }} />
                </div>
              </div>
            </div>
          </div>
