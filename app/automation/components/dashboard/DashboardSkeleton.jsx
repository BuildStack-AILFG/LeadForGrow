        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            <div className="lg:col-span-7 xl:col-span-8 grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3">
              {[1, 2, 3, 4, 5].map((i) => (
                <Block key={i} className="h-[96px] border border-[#E9ECEF] dark:border-slate-700" />
              ))}
              <Block className="col-span-2 sm:col-span-3 xl:col-span-5 h-[300px] border border-[#E9ECEF] dark:border-slate-700" />
            </div>
            <Block className="lg:col-span-5 xl:col-span-4 min-h-[420px] border border-[#E9ECEF] dark:border-slate-700" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <Block className="h-[280px] border border-[#E9ECEF] dark:border-slate-700" />
            <Block className="h-[280px] border border-[#E9ECEF] dark:border-slate-700" />
            <Block className="h-[280px] border border-[#E9ECEF] dark:border-slate-700" />
          </div>
        </div>
