...
export const INTROS = [
  ...
  { id: 'deal-pipeline', path: '/automation/pipelines', tone: 'blue', icon: 'Columns3',
    ...
    guideHref: '/help/deals-pipeline' },
  { id: 'bills', path: '/automation/bills', tone: 'emerald', icon: 'Receipt',
  ...
  { id: 'sequences', path: '/automation/sequences', tone: 'emerald', icon: 'Route',
  ...
  { id: 'journeys', path: '/automation/journeys', tone: 'emerald', icon: 'Map',
  ...
  { id: 'whatsapp-templates', path: '/automation/whatsapp-templates', tone: 'emerald', icon: 'MessageCircleMore',
    ...
    guideHref: '/help/create-template' },
  { id: 'chatbot', path: '/automation/chatbot', tone: 'emerald', icon: 'Bot',
  ...
  { id: 'automation-analytics', path: '/automation/automation-analytics', tone: 'emerald', icon: 'Activity',
    iconImage: '/automation-analytics-icon.webp',
  ...
  { id: 'events', path: '/automation/events', tone: 'slate', icon: 'CalendarDays',
    ...
    guideHref: '/help/reports-analytics' },
  { id: 'ai-knowledge', path: '/automation/ai/knowledge', tone: 'emerald', icon: 'Brain',
    iconImage: '/ai-knowledge-icon.svg', iconFullBleed: true,
  ...
  { id: 'ai-settings', path: '/automation/settings/ai', tone: 'emerald', icon: 'Sparkles',
    iconImage: '/ai-settings-icon.svg', iconFullBleed: true,
