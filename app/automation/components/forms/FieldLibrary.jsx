  ...
  return (
    <div className="h-full flex flex-col">
      <div className="px-1 pb-3">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Click to add to your form</p>
      </div>
          ...
          return (
            <div key={cat.id}>
              <button
                ...
                className="w-full flex items-center justify-between px-2 py-2 text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 rounded-lg transition-colors"
              >
                {cat.label}
