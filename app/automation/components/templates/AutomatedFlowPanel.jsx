  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <label className="flex items-center gap-3 px-4 py-2 bg-slate-50 dark:bg-slate-800/50 rounded cursor-pointer">
      ...
      <div className="p-6 space-y-5">
        ...
        <div>
          ...
          {showPreview ? (
            <div className="p-5 bg-slate-50 dark:bg-slate-800/50 rounded text-sm whitespace-pre-wrap leading-relaxed min-h-[200px] text-slate-700 dark:text-slate-300">
