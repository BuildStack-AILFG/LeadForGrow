  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      <div className="w-16 h-16 rounded-2xl bg-[#F9FAFB] dark:bg-slate-900 border border-[#E5E7EB] dark:border-slate-700 flex items-center justify-center mb-5">
        <Building2 className="w-8 h-8 text-[#98A2B3] dark:text-slate-400" strokeWidth={1.5} />
      </div>
      <h3 className="text-[16px] font-semibold text-[#101828] dark:text-slate-100 mb-1">No companies yet</h3>
